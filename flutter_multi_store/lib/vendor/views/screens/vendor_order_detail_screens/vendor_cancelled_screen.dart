...
class VendorCancelledScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _ordersStream =
        FirebaseFirestore.instance
            ...
            .where('deliverystatus', isEqualTo: 'cancelled')
            .snapshots();
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  document['deliverystatus'] == 'cancelled'
                                      ? TextButton(
                                        onPressed: null,
                                        child: Text(
                                          '',
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          document['paymentStatus'].toString(),
                                          style: TextStyle(
                                            fontSize: 15,
                                            fontWeight: FontWeight.bold,
                                          ),
